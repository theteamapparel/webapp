...
def activateEmail(request, user, to_email):
    ...
    try:
        ...
        send_mail(mail_subject,message,settings.EMAIL_FROM,[to_email], html_message=message)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if associated_user:
                ...
                try:
                    send_mail(subject,message,settings.EMAIL_FROM,[associated_user.email], html_message=message)
