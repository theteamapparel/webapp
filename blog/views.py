...
from .forms import NewsletterForm, ArticleCreateForm, ArticleUpdateForm#, NewsletterForm
from users.models import SubscribedUsers
...
def homepage(request):
    matching_series = Article.objects.all()
...
def article(request, article: str):
    matching_article = Article.objects.filter(article_slug=article).first()
